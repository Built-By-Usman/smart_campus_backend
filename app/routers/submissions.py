...
def assignment_updation(
    ...
    return update_submission(
        submission_id=submission_id, request=request, db=db, current_user=current_user
    )
...
def delete_assignment(
    ...
    return delete_submission(
        submission_id=submission_id, db=db, current_user=current_user
    )
